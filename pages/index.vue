  ...
  <aside class="w-64 bg-white border-r border-slate-200 hidden md:flex flex-col">
    ...
    <main class="flex-1 p-8 overflow-y-auto">
      <header class="mb-8 flex justify-between items-center">
        ...
        <button @click="abrirModal" class="bg-blue-600 hover:bg-blue-700 text-white px-4 py-2 rounded-lg font-medium transition shadow-sm flex items-center gap-2">
        ...
        <div class="bg-white p-6 rounded-xl shadow-xl w-96">
          ...
          <form @submit.prevent="salvarLancamento">
            ...
            <div class="flex gap-2 justify-end">
              ...
              <button type="submit" class="px-4 py-2 bg-blue-600 text-white rounded hover:bg-blue-700 font-medium">Salvar</button>
            </div>
          </form>
        </div>
      </div>
