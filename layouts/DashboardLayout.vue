  ...
  <div class="flex min-h-screen bg-slate-50 font-sans text-slate-900">
    ...
    <aside class="w-64 bg-white border-r border-slate-200 hidden md:flex flex-col">
      ...
      <nav class="flex-1 p-4 space-y-1">
        ...
        <NuxtLink to="/" class="px-3 py-2 text-blue-600 bg-blue-50 rounded-md font-medium cursor-pointer flex items-center gap-3">
...
// Adicionamos a função logout aqui, já que ela pertence ao layout.
